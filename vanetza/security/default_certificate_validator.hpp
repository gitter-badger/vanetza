...
{
public:
    DefaultCertificateValidator(Backend&, const Clock::time_point& time_now, facilities::PositionProvider&, const TrustStore&, CertificateCache&);
...
private:
    ...
    facilities::PositionProvider& m_position_provider;
