...
{
public:
    RouterContext(boost::asio::generic::raw_protocol::socket&, const vanetza::geonet::MIB&, TimeTrigger&, vanetza::facilities::PositionProvider&, vanetza::security::SecurityEntity&);
    ~RouterContext();
...
private:
    ...
    vanetza::facilities::PositionProvider& positioning_;
