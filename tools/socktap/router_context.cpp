...
RouterContext::RouterContext(raw_protocol::socket& socket, const geonet::MIB& mib, TimeTrigger& trigger, vanetza::facilities::PositionProvider& positioning, vanetza::security::SecurityEntity& security_entity) :
...
{
    router_.update_position(positioning_.last_position_fix());
